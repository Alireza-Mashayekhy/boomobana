...
const Footer = () => {
  return (
    <div className='px-12 py-10 bg-[url("/images/footer.png")] bg-no-repeat bg-cover bg-center flex justify-between gap-5'>
      <div className='w-2/6'>
        ...
        <p className='text-white font-extralight mt-7'>
          ...
          هوشمندانه‌ای را برای تمامی فعالان حوزه‌های مسکن و گردشگری فراهم می‌کند. این پلتفرم با ارائه ابزارهای
          نوآورانه و امکان دریافت درخواست‌های متنوع، فرصت‌های جدیدی برای درآمدزایی و تجربه‌ای منحصربه‌فرد در
          این حوزه‌ها ایجاد کرده است.
        </p>
      </div>
      ...
      <div className='flex flex-col items-center'>
        <div className='flex items-start'>
          ...
          />
          <Image src='/images/enamad.png' alt='enamad' width={100} height={130} className='w-20 min-w-20 ' />
          <Image src='/images/majazi.png' alt='majazi' width={100} height={130} className='w-24 min-w-24 ' />
        </div>
