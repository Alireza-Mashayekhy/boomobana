...
export const Banner = () => {
  return (
    <div className='flex flex-col lg:flex-row gap-5 sm:gap-10'>
      <div className='w-full lg:w-2/3 p-10 lg:p-0 relative bg-[url("/images/homeBanner.jpg")] bg-no-repeat bg-cover flex flex-col items-center justify-center rounded-2xl'>
        <div className='absolute py-2 px-10 top-0 right-0 text-xl sm:text-3xl font-bold bg-white rounded-bl-xl'>
          پست های ویژه
        </div>
        <div className='text-white sm:text-xl font-semibold max-w-96 w-full text-left'>10/شهریور/1404</div>
        <div className='text-white text-xl sm:text-3xl font-semibold max-w-96 leading-relaxed'>
      ...
      <div className='flex flex-col sm:flex-row lg:flex-col gap-5 sm:gap-10 w-full lg:w-1/3 text-white'>
